...
public enum Router: CustomStringConvertible {
    ...
    public var description: String {
        ...
        case .UploadAttachment(let v): return "UploadAttachment(topicId=\(v.0))"
        case .GetTopicMembers(let v): return "GetTopicMembers(topicId=\(v.0))"
        ...
        case .FavoriteTopic(let v): return "FavoriteTopic(topicId=\(v.0))"
        case .UnfavoriteTopic(let v): return "UnfavoriteTopic(topicId=\(v.0))"
        ...
        case .SaveReadMention(let v): return "SaveReadMention(mentionId=\(v.0))"
        ...
        case .DeleteTopic(let v): return "DeleteTopic(topicId=\(v.0))"
        case .GetTopicDetails(let v): return "GetTopicDetails(topicId=\(v.0))"
