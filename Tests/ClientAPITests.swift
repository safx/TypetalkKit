...
class ClientAPITests: XCTestCase {
	...
	func testGetTopics() {
		...
		TypetalkAPI.send(GetTopics(spaceKey: "")) { result in
			...
			case .success(let r):
				...
				XCTAssertEqual(r.topics[3].topic.description, "A place to provide feedback on the recent redesign of our website")
				...
				XCTAssertEqual(r.topics[4].topic.description, "All about the world of visual design which include app ui/ux, website, news, tips and occasional banter among designers. Oh, and don't forget the weekend together.\n\nSome housekeeping:\n 1. Share your work and comment on others' work in a nice manners.\n 2. Report any issue to @Stefanie\n 3. Have fun typetalkin'! https://typetalk.com\n\nNote that this topic is open to everyone in the team!")
				...
				XCTAssertEqual(r.topics[5].topic.description, "Company related announcements and info.")
				...
				XCTAssertEqual(r.topics[9].topic.description, "For the development team to coordinate on projects")
				...
				XCTAssertEqual(r.topics[10].topic.description, "")
				...
				XCTAssertEqual(r.topics[11].topic.description, "")
				...
				XCTAssertEqual(r.topics[12].topic.description, "")
	...
	func testGetMessages() {
		...
		TypetalkAPI.send(GetMessages(topicId: 0)) { result in
			...
			case .success(let r):
				...
				XCTAssertEqual(r.posts[0].account.imageUrl.absoluteString, "https://typetalk.com/accounts/103/profile_image.png?t=1403836349000")
				...
				XCTAssertEqual(r.posts[0].attachments![0].webUrl.absoluteString, "https://typetalk.com/topics/208/posts/300/attachments/1/1.jpg")
				...
				XCTAssertEqual(r.posts[0].attachments![0].apiUrl.absoluteString, "https://typetalk.com/api/v1/topics/208/posts/300/attachments/1/1.jpg")
				XCTAssertEqual(r.posts[0].attachments![1].webUrl.absoluteString, "https://typetalk.com/topics/208/posts/300/attachments/2/2.jpg")
				...
				XCTAssertEqual(r.posts[0].attachments![1].apiUrl.absoluteString, "https://typetalk.com/api/v1/topics/208/posts/300/attachments/2/2.jpg")
				XCTAssertEqual(r.posts[0].attachments![2].webUrl.absoluteString, "https://typetalk.com/topics/208/posts/300/attachments/3/5.jpg")
				...
				XCTAssertEqual(r.posts[0].attachments![2].apiUrl.absoluteString, "https://typetalk.com/api/v1/topics/208/posts/300/attachments/3/5.jpg")
				XCTAssertEqual(r.posts[0].attachments![3].webUrl.absoluteString, "https://typetalk.com/topics/208/posts/300/attachments/4/6.jpg")
				...
				XCTAssertEqual(r.posts[0].attachments![3].apiUrl.absoluteString, "https://typetalk.com/api/v1/topics/208/posts/300/attachments/4/6.jpg")
				...
				XCTAssertEqual(r.posts[0].links![1].embed!.type.rawValue, "rich")
				 */
				...
				XCTAssertEqual(r.posts[2].account.imageUrl.absoluteString, "https://typetalk.com/accounts/102/profile_image.png?t=1403749949000")
				...
				XCTAssertEqual(r.posts[2].likes![0].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/100/profile_image.png?t=1403577149000")
				...
				XCTAssertEqual(r.posts[2].likes![1].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/101/profile_image.png?t=1403663549000")
				...
				XCTAssertEqual(r.posts[2].likes![2].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/103/profile_image.png?t=1403836349000")
				...
				XCTAssertEqual(r.posts[3].account.imageUrl.absoluteString, "https://typetalk.com/accounts/103/profile_image.png?t=1403836349000")
				...
				XCTAssertEqual(r.posts[4].account.imageUrl.absoluteString, "https://typetalk.com/accounts/102/profile_image.png?t=1403749949000")
				...
				XCTAssertEqual(r.posts[5].account.imageUrl.absoluteString, "https://typetalk.com/accounts/104/profile_image.png?t=1403922749000")
				...
				XCTAssertEqual(r.posts[6].account.imageUrl.absoluteString, "https://typetalk.com/accounts/100/profile_image.png?t=1403577149000")
				...
				XCTAssertEqual(r.posts[6].likes![0].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/101/profile_image.png?t=1403663549000")
				...
				XCTAssertEqual(r.posts[6].likes![1].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/102/profile_image.png?t=1403749949000")
				...
				XCTAssertEqual(r.posts[6].likes![2].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/103/profile_image.png?t=1403836349000")
				...
				XCTAssertEqual(r.posts[6].likes![3].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/104/profile_image.png?t=1403922749000")
				...
				XCTAssertEqual(r.posts[6].likes![4].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/105/profile_image.png?t=1404009149000")
				...
				XCTAssertEqual(r.posts[7].account.imageUrl.absoluteString, "https://typetalk.com/accounts/100/profile_image.png?t=1403577149000")
				...
				XCTAssertEqual(r.posts[7].likes![0].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/100/profile_image.png?t=1403577149000")
	...
	func testPostMessage() {
		...
		TypetalkAPI.send(PostMessage(topicId: 0, message: "foo")) { result in
			...
			case .success(let r):
				...
				XCTAssertEqual(r.post!.account.imageUrl.absoluteString, "https://typetalk.com/accounts/100/profile_image.png?t=1403577149000")
	...
	func testGetMessage() {
		...
		TypetalkAPI.send(GetMessage(topicId: 0, postId: 0)) { result in
			...
			case .success(let r):
				...
				XCTAssertEqual(r.replies![0].account.imageUrl.absoluteString, "https://typetalk.com/accounts/104/profile_image.png?t=1403922749000")
				...
				XCTAssertEqual(r.replies![1].account.imageUrl.absoluteString, "https://typetalk.com/accounts/100/profile_image.png?t=1403577149000")
				...
				XCTAssertEqual(r.replies![1].likes![0].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/101/profile_image.png?t=1403663549000")
				...
				XCTAssertEqual(r.replies![1].likes![1].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/102/profile_image.png?t=1403749949000")
				...
				XCTAssertEqual(r.replies![1].likes![2].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/103/profile_image.png?t=1403836349000")
				...
				XCTAssertEqual(r.replies![1].likes![3].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/104/profile_image.png?t=1403922749000")
				...
				XCTAssertEqual(r.replies![1].likes![4].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/105/profile_image.png?t=1404009149000")
				...
				XCTAssertEqual(r.post.likes![0].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/100/profile_image.png?t=1403577149000")
	...
	func testSearchMessages() {
		...
		TypetalkAPI.send(SearchMessages(q: "", spaceKey: "")) { result in
			...
			case .success(let r):
				...
				XCTAssertNil(r.posts[0].replyTo)
				XCTAssertEqual(r.posts[0].topic!.description, "This is awesome.")
	...
	func testLikeMessage() {
		...
		TypetalkAPI.send(LikeMessage(topicId: 0, postId: 0)) { result in
			...
			case .success(let r):
				...
				XCTAssertEqual(r.post!.account.imageUrl.absoluteString, "https://typetalk.com/accounts/104/profile_image.png?t=1403922749000")
				XCTAssertEqual(r.post!.account.isBot, false)
				...
				XCTAssertEqual(r.like.account!.imageUrl.absoluteString, "https://typetalk.com/accounts/100/profile_image.png?t=1403577149000")
	...
	func testGetDirectMessages() {
        ...
        TypetalkAPI.send(GetDirectMessages(spaceKey: "foo", accountName: "foo")) { result in
			...
			case .success(let r):
				...
				XCTAssertEqual(r.directMessage.account.imageUrl.absoluteString, "https://typetalk.com/accounts/101/profile_image.png?t=1403663549000")
	...
	func testGetNotificationStatus() {
		...
		TypetalkAPI.send(GetNotificationStatus()) { result in
			switch result {
			case .success(let r):
				XCTAssertEqual(r.doNotDisturb.scheduled.start, "22:00")
				XCTAssertEqual(r.doNotDisturb.scheduled.end, "07:00")
				XCTAssertEqual(r.doNotDisturb.scheduled.enabled, true)
				XCTAssertEqual(r.doNotDisturb.isSuppressed, false)
				XCTAssertNil(r.doNotDisturb.manual.remainingTimeInMinutes)
				XCTAssertEqual(r.statuses.count, 4)
				XCTAssertEqual(r.statuses[0].access!.unopenedExcludeDM, 0)
				XCTAssertEqual(r.statuses[0].access!.unopened, 0)
				XCTAssertEqual(r.statuses[0].directMessage!.unreadTopics, 0)
				...
				XCTAssertEqual(r.statuses[0].mySpace!.myPlan.updatedAt.description, "2018-03-09 12:29:30 +0000")
				XCTAssertEqual(r.statuses[0].mySpace!.myPlan.totalAttachmentSize, 0)
				XCTAssertEqual(r.statuses[0].mySpace!.myPlan.createdAt.description, "2016-01-27 09:37:27 +0000")
				XCTAssertEqual(r.statuses[0].mySpace!.space.imageUrl.absoluteString, "https://dev.apps.nulab-inc.com/spaces/xxxxxxxxx/photo/large")
				...
				XCTAssertEqual(r.statuses[0].like!.receive!.readLikeId, 19747)
				XCTAssertEqual(r.statuses[0].like!.receive!.hasUnread, false)
				XCTAssertEqual(r.statuses[0].space!.imageUrl.absoluteString, "https://dev.apps.nulab-inc.com/spaces/xxxxxxxxx/photo/large")
				XCTAssertEqual(r.statuses[0].space!.enabled, true)
				XCTAssertEqual(r.statuses[0].space!.name, "Awesome Tech Inc.")
				XCTAssertEqual(r.statuses[0].space!.key, "xxxxxxxxx")
				XCTAssertEqual(r.statuses[1].access!.unopenedExcludeDM, 0)
				XCTAssertEqual(r.statuses[1].access!.unopened, 0)
				XCTAssertEqual(r.statuses[1].directMessage!.unreadTopics, 0)
				XCTAssertEqual(r.statuses[1].mySpace!.myRole, "ADMIN")
				XCTAssertEqual(r.statuses[1].mySpace!.isPaymentAdmin, true)
				XCTAssertEqual(r.statuses[1].mySpace!.invitableRoles!.count, 3)
				XCTAssertEqual(r.statuses[1].mySpace!.invitableRoles![0], "ADMIN")
				XCTAssertEqual(r.statuses[1].mySpace!.invitableRoles![1], "USER")
				XCTAssertEqual(r.statuses[1].mySpace!.invitableRoles![2], "GUEST")
				XCTAssertEqual(r.statuses[1].mySpace!.myPlan.numberOfUsers, 2)
				XCTAssertEqual(r.statuses[1].mySpace!.myPlan.enabled, false)
				XCTAssertEqual(r.statuses[1].mySpace!.myPlan.trial!.endDate, "2017-03-02")
				XCTAssertEqual(r.statuses[1].mySpace!.myPlan.trial!.daysLeft, -375)
				XCTAssertEqual(r.statuses[1].mySpace!.myPlan.plan.limitNumberOfUsers, 10)
				XCTAssertEqual(r.statuses[1].mySpace!.myPlan.plan.name, "Starter Plan")
				XCTAssertEqual(r.statuses[1].mySpace!.myPlan.plan.key, "typetalk.starter")
				XCTAssertEqual(r.statuses[1].mySpace!.myPlan.plan.limitTotalAttachmentSize, 10737418240)
				XCTAssertEqual(r.statuses[1].mySpace!.myPlan.updatedAt.description, "2018-02-19 10:54:29 +0000")
				XCTAssertEqual(r.statuses[1].mySpace!.myPlan.totalAttachmentSize, 0)
				XCTAssertEqual(r.statuses[1].mySpace!.myPlan.createdAt.description, "2016-01-29 09:58:11 +0000")
				XCTAssertEqual(r.statuses[1].mySpace!.space.imageUrl.absoluteString, "https://dev.apps.nulab-inc.com/spaces/xxxxxxxxx/photo/large")
				XCTAssertEqual(r.statuses[1].mySpace!.space.enabled, true)
				XCTAssertEqual(r.statuses[1].mySpace!.space.name, "Example Organization")
				XCTAssertEqual(r.statuses[1].mySpace!.space.key, "xxxxxxxxx")
				XCTAssertNil(r.statuses[1].like!.receive!.readLikeId)
				XCTAssertEqual(r.statuses[1].like!.receive!.hasUnread, false)
				XCTAssertEqual(r.statuses[1].space!.imageUrl.absoluteString, "https://dev.apps.nulab-inc.com/spaces/xxxxxxxxx/photo/large")
				XCTAssertEqual(r.statuses[1].space!.enabled, true)
				XCTAssertEqual(r.statuses[1].space!.name, "Example Organization")
				XCTAssertEqual(r.statuses[1].space!.key, "xxxxxxxxx")
				XCTAssertEqual(r.statuses[2].access!.unopenedExcludeDM, 0)
				XCTAssertEqual(r.statuses[2].access!.unopened, 0)
				XCTAssertEqual(r.statuses[2].directMessage!.unreadTopics, 0)
				XCTAssertEqual(r.statuses[2].mySpace!.myRole, "ADMIN")
				XCTAssertEqual(r.statuses[2].mySpace!.isPaymentAdmin, true)
				XCTAssertEqual(r.statuses[2].mySpace!.invitableRoles!.count, 3)
				XCTAssertEqual(r.statuses[2].mySpace!.invitableRoles![0], "ADMIN")
				XCTAssertEqual(r.statuses[2].mySpace!.invitableRoles![1], "USER")
				XCTAssertEqual(r.statuses[2].mySpace!.invitableRoles![2], "GUEST")
				XCTAssertEqual(r.statuses[2].mySpace!.myPlan.numberOfUsers, 2)
				XCTAssertEqual(r.statuses[2].mySpace!.myPlan.enabled, true)
				XCTAssertNil(r.statuses[2].mySpace!.myPlan.trial)
				XCTAssertEqual(r.statuses[2].mySpace!.myPlan.plan.limitNumberOfUsers, 10)
				XCTAssertEqual(r.statuses[2].mySpace!.myPlan.plan.name, "Free Plan")
				XCTAssertEqual(r.statuses[2].mySpace!.myPlan.plan.key, "typetalk.free")
				XCTAssertEqual(r.statuses[2].mySpace!.myPlan.plan.limitTotalAttachmentSize, 1073741824)
				XCTAssertEqual(r.statuses[2].mySpace!.myPlan.updatedAt.description, "2018-02-23 03:20:05 +0000")
				XCTAssertEqual(r.statuses[2].mySpace!.myPlan.totalAttachmentSize, 0)
				XCTAssertEqual(r.statuses[2].mySpace!.myPlan.createdAt.description, "2018-02-23 03:17:16 +0000")
				XCTAssertEqual(r.statuses[2].mySpace!.space.imageUrl.absoluteString, "https://dev.apps.nulab-inc.com/spaces/xxxxxxxxx/photo/large")
				XCTAssertEqual(r.statuses[2].mySpace!.space.enabled, true)
				XCTAssertEqual(r.statuses[2].mySpace!.space.name, "Fabulous Tech Inc.")
				XCTAssertEqual(r.statuses[2].mySpace!.space.key, "xxxxxxxxx")
				XCTAssertNil(r.statuses[2].like!.receive!.readLikeId)
				XCTAssertEqual(r.statuses[2].like!.receive!.hasUnread, false)
				XCTAssertEqual(r.statuses[2].space!.imageUrl.absoluteString, "https://dev.apps.nulab-inc.com/spaces/xxxxxxxxx/photo/large")
				XCTAssertEqual(r.statuses[2].space!.enabled, true)
				XCTAssertEqual(r.statuses[2].space!.name, "Fabulous Tech Inc.")
				XCTAssertEqual(r.statuses[2].space!.key, "xxxxxxxxx")
				XCTAssertEqual(r.statuses[3].access!.unopenedExcludeDM, 0)
				XCTAssertEqual(r.statuses[3].access!.unopened, 0)
				XCTAssertEqual(r.statuses[3].directMessage!.unreadTopics, 0)
				XCTAssertNil(r.statuses[3].mySpace)
				XCTAssertEqual(r.statuses[3].like!.receive!.readLikeId, 19554)
				XCTAssertEqual(r.statuses[3].like!.receive!.hasUnread, false)
				XCTAssertNil(r.statuses[3].space)
	...
	func testOpenNotification() {
        ...
        TypetalkAPI.send(OpenNotification(spaceKey: "foo")) { result in
			...
			case .success(let r):
				...
				XCTAssertEqual(r.access!.unopenedExcludeDM, 0)
				XCTAssertEqual(r.access!.unopened, 0)
				XCTAssertNil(r.space)
	...
	func testGetFriends() {
		...
		TypetalkAPI.send(GetFriends(q: "", spaceKey: "")) { result in
			...
			case .success(let r):
				...
				XCTAssertEqual(r.accounts[0].name, "Dom")
				XCTAssertEqual(r.accounts[0].imageUrl.absoluteString, "https://dev.typetalk.com/accounts/2497/profile_image.png?t=1510596200433")
				XCTAssertEqual(r.accounts[0].isBot, false)
				XCTAssertEqual(r.accounts[0].suggestion, "Dom Lewis")
				XCTAssertEqual(r.accounts[0].updatedAt.description, "2018-02-20 04:49:37 +0000")
				XCTAssertEqual(r.accounts[0].fullName, "Dom Lewis")
				XCTAssertEqual(r.accounts[0].id, 2497)
				XCTAssertEqual(r.accounts[0].createdAt.description, "2016-01-27 09:54:48 +0000")
				XCTAssertEqual(r.accounts[1].name, "Jessica")
				XCTAssertEqual(r.accounts[1].imageUrl.absoluteString, "https://dev.typetalk.com/accounts/2500/profile_image.png?t=1454061730873")
				XCTAssertEqual(r.accounts[1].isBot, false)
				XCTAssertEqual(r.accounts[1].suggestion, "Jessica Lee")
				XCTAssertEqual(r.accounts[1].updatedAt.description, "2018-03-13 09:40:15 +0000")
				XCTAssertEqual(r.accounts[1].fullName, "Jessica Lee")
				XCTAssertEqual(r.accounts[1].id, 2500)
				XCTAssertEqual(r.accounts[1].createdAt.description, "2016-01-27 09:55:35 +0000")
				XCTAssertEqual(r.accounts[2].name, "Moss")
				XCTAssertEqual(r.accounts[2].imageUrl.absoluteString, "https://dev.typetalk.com/accounts/2499/profile_image.png?t=1453891379196")
				XCTAssertEqual(r.accounts[2].isBot, false)
				XCTAssertEqual(r.accounts[2].suggestion, "Moss Harris")
				XCTAssertEqual(r.accounts[2].updatedAt.description, "2018-02-23 03:14:51 +0000")
				XCTAssertEqual(r.accounts[2].fullName, "Moss Harris")
				XCTAssertEqual(r.accounts[2].id, 2499)
				XCTAssertEqual(r.accounts[2].createdAt.description, "2016-01-27 09:55:23 +0000")
				XCTAssertEqual(r.accounts[3].name, "Stefanie")
				XCTAssertEqual(r.accounts[3].imageUrl.absoluteString, "https://dev.typetalk.com/accounts/2498/profile_image.png?t=1453891479138")
				XCTAssertEqual(r.accounts[3].isBot, false)
				XCTAssertEqual(r.accounts[3].suggestion, "Stefanie Fisher")
				XCTAssertEqual(r.accounts[3].updatedAt.description, "2018-02-20 04:49:37 +0000")
				XCTAssertEqual(r.accounts[3].fullName, "Stefanie Fisher")
				XCTAssertEqual(r.accounts[3].id, 2498)
				XCTAssertEqual(r.accounts[3].createdAt.description, "2016-01-27 09:55:09 +0000")
	...
	func testGetReceivedLikes() {
		...
		TypetalkAPI.send(GetReceivedLikes(spaceKey: "")) { result in
			...
			case .success(let r):
				...
				XCTAssertEqual(r.likedPosts[0].post!.topic!.description, "")
				XCTAssertEqual(r.likedPosts[0].post!.topic!.lastPostedAt!.description, "2014-06-30 02:32:29 +0000")
				XCTAssertEqual(r.likedPosts[0].post!.topic!.name, "Techies")
				XCTAssertEqual(r.likedPosts[0].post!.topic!.suggestion, "Techies")
				XCTAssertEqual(r.likedPosts[0].post!.topic!.updatedAt.description, "2014-06-05 02:32:29 +0000")
				XCTAssertEqual(r.likedPosts[0].post!.topic!.id, 203)
				XCTAssertEqual(r.likedPosts[0].post!.topic!.createdAt.description, "2014-06-05 02:32:29 +0000")
				XCTAssertEqual(r.likedPosts[0].post!.topic!.isDirectMessage, false)
				//XCTAssertNil(r.likedPosts[0].post!.directMessage)
				...
				XCTAssertEqual(r.likedPosts[0].likes.count, 1)
				XCTAssertEqual(r.likedPosts[0].likes[0].comment, "")
				XCTAssertEqual(r.likedPosts[0].likes[0].topicId, 203)
				XCTAssertEqual(r.likedPosts[0].likes[0].account!.name, "jessica")
				XCTAssertEqual(r.likedPosts[0].likes[0].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/100/profile_image.png?t=1403577149000")
				XCTAssertEqual(r.likedPosts[0].likes[0].account!.isBot, false)
				XCTAssertEqual(r.likedPosts[0].likes[0].account!.suggestion, "Jessica Fitzherbert")
				XCTAssertEqual(r.likedPosts[0].likes[0].account!.updatedAt.description, "2014-06-24 02:32:29 +0000")
				XCTAssertEqual(r.likedPosts[0].likes[0].account!.fullName, "Jessica Fitzherbert")
				XCTAssertEqual(r.likedPosts[0].likes[0].account!.id, 100)
				XCTAssertEqual(r.likedPosts[0].likes[0].account!.createdAt.description, "2014-06-24 02:32:29 +0000")
				XCTAssertEqual(r.likedPosts[0].likes[0].postId, 309)
				XCTAssertEqual(r.likedPosts[0].likes[0].id, 605)
				XCTAssertEqual(r.likedPosts[0].likes[0].createdAt!.description, "2016-12-21 10:12:06 +0000")
				...
				XCTAssertEqual(r.likedPosts[1].post!.topic!.description, "")
				XCTAssertEqual(r.likedPosts[1].post!.topic!.lastPostedAt!.description, "2014-06-30 02:32:29 +0000")
				XCTAssertEqual(r.likedPosts[1].post!.topic!.name, "Arts & Crafts Club")
				XCTAssertEqual(r.likedPosts[1].post!.topic!.suggestion, "Arts & Crafts Club")
				XCTAssertEqual(r.likedPosts[1].post!.topic!.updatedAt.description, "2014-06-04 02:32:29 +0000")
				XCTAssertEqual(r.likedPosts[1].post!.topic!.id, 202)
				XCTAssertEqual(r.likedPosts[1].post!.topic!.createdAt.description, "2014-06-04 02:32:29 +0000")
				XCTAssertEqual(r.likedPosts[1].post!.topic!.isDirectMessage, false)
				//XCTAssertNil(r.likedPosts[1].post!.directMessage)
				...
				XCTAssertEqual(r.likedPosts[1].likes.count, 1)
				XCTAssertEqual(r.likedPosts[1].likes[0].comment, "")
				XCTAssertEqual(r.likedPosts[1].likes[0].topicId, 202)
				XCTAssertEqual(r.likedPosts[1].likes[0].account!.name, "jessica")
				XCTAssertEqual(r.likedPosts[1].likes[0].account!.imageUrl.absoluteString, "https://typetalk.com/accounts/100/profile_image.png?t=1403577149000")
				XCTAssertEqual(r.likedPosts[1].likes[0].account!.isBot, false)
				XCTAssertEqual(r.likedPosts[1].likes[0].account!.suggestion, "Jessica Fitzherbert")
				XCTAssertEqual(r.likedPosts[1].likes[0].account!.updatedAt.description, "2014-06-24 02:32:29 +0000")
				XCTAssertEqual(r.likedPosts[1].likes[0].account!.fullName, "Jessica Fitzherbert")
				XCTAssertEqual(r.likedPosts[1].likes[0].account!.id, 100)
				XCTAssertEqual(r.likedPosts[1].likes[0].account!.createdAt.description, "2014-06-24 02:32:29 +0000")
				XCTAssertEqual(r.likedPosts[1].likes[0].postId, 308)
				XCTAssertEqual(r.likedPosts[1].likes[0].id, 604)
				XCTAssertEqual(r.likedPosts[1].likes[0].createdAt!.description, "2016-12-21 10:12:06 +0000")
